...
_DATA = Path(os.environ.get("POLYTUTOR_DATA_DIR", str(ROOT / "_DataMetricPulls")))
ELON_OSINT_ARCHIVE = _DATA / "osint" / "elon-tweets-archive" / "elonmusk-ALL-2025-12-10.json"
ELON_OSINT_2ND = _DATA / "osint" / "elon-tweets-archive" / "elonmusk_tweets_2025-11-02T01-12-31-543Z.json"
ELON_SCWEET_DIR = _DATA / "osint" / "scweet" / "scweet_results"
ELON_XTRACKER = _DATA / "elon_posts_raw.parquet"
OUT_DIR = _DATA / "canonical" / "posts_history"
