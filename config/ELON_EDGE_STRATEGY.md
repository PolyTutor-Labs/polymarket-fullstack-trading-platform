...
Backtests (all in `research/backtests/pacing_backtest/`, obey `BACKTEST_RULES.md`):
...
- Counts: X-API backfill `research/backtests/pacing_backtest/elon_backfill_2025-09_to_now.parquet`
