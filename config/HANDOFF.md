...
`research/backtests/pacing_backtest/pattern_discovery_2026-07-26.py`, `pattern_discovery_lib.py`, `pattern_discovery_methods.py`.

**The contract it must obey:** `research/backtests/pacing_backtest/prereg/pattern_discovery_2026-07-26.md` (written BEFORE any sealed data was opened; fixes the wall dates, the 7 methods, the 4 baselines, the scoring, the trial count and the success criteria).
...
- **Reconstruction engine** lives in `research/backtests/pacing_backtest/pace_reconstruction.py` (Elon) and is the transferable asset. See memory `edge_map_elon_efficient`.
...
- Task file: `~/.claude/scheduled-tasks/polymarket-bot-daily-qa/SKILL.md`
