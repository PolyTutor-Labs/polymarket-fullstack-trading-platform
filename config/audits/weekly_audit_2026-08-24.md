...
- `backtest/engine.py` (top-level, not under `api/`): **dead/unreachable** — zero importers
  ...
  left as a landmine.
- The **active** suite, `research/backtests/pacing_backtest/*.py` (54 scripts) governed by
...
(`research/backtests/pacing_backtest/*_test.py`, `scripts/canonical/07_consistency_test.py`) as test
