...
OUT=ROOT+"/research/backtests/pacing_backtest/audit_out3"; ET=ZoneInfo('America/New_York')
...
bf=pd.read_parquet(ROOT+"/research/backtests/pacing_backtest/elon_backfill_2025-09_to_now.parquet"); bf=bf[bf.counts_main_feed].sort_values('ms'); tw_ms=bf.ms.to_numpy().astype('int64')
def noon(sl):
