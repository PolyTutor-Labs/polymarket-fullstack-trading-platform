...
`research/backtests/pacing_backtest/prereg/regime_discovery_2026-07-29.md` -- read
...
def write_summary(q1_results, q2, out_path):
    ...
    A("")
    A("Pre-registration: `research/backtests/pacing_backtest/prereg/regime_discovery_2026-07-29.md`. "
