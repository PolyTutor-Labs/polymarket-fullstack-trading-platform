...
SCRATCH = Path(os.environ.get("POLYTUTOR_OUTPUT_DIR", str(ROOT / "output"))) / "scratch"
...
def main():
    ...
    ap.add_argument("--out", default=str(ROOT / "research/backtests/pacing_backtest/audit_out_weather"))
    a = ap.parse_args()
