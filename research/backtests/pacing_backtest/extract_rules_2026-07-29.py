...
emit_run_meta(
    ...
    data_paths=[
        "research/backtests/pacing_backtest/elon_backfill_2025-09_to_now.parquet",
        "research/backtests/pacing_backtest/pattern_discovery_2026-07-26.py (imported read-only, reused "
        "build_targets()/WALL_ELON/CHECKPOINTS_*/make_prior_final_fn/build_daily_brackets, main() never called)",
        "research/backtests/pacing_backtest/pattern_discovery_lib.py (imported, reused)",
        "research/backtests/pacing_backtest/pattern_discovery_methods.py (imported, reused fit_M2/fit_M3_centroids/"
        "fit_M4/fit_M5/build_features/_assign_cluster/_hourly_seq)",
        "research/backtests/pacing_backtest/pattern_discovery_out/summary.md + run_dstfix_2026-07-31.log "
