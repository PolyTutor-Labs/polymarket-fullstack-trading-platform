...
| Purpose | Path |
|---|---|
| Elon posts (clean X-API) | `research/backtests/pacing_backtest/elon_backfill_2025-09_to_now.parquet` (+ `_ext_to_2026-07-10`) |
...
## Required outputs
1. `===RUN_META===` block via `research/backtests/pacing_backtest/run_meta.py::emit_run_meta`, declaring model_version, git_sha, headline, n_auctions, trial_count, scope, window_basis, data_paths.
