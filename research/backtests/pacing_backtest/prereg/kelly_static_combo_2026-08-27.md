...
## File scope
Script `research/backtests/pacing_backtest/kelly_static_combo_2026-08-27.py`, outputs `research/backtests/pacing_backtest/kelly_out/`. Do NOT modify `pattern_discovery_*`, `regime_*`, `extract_rules_*`, `combo_out/`, `rules_out/`, or any other prereg.
