...
## File boundaries
Script `research/backtests/pacing_backtest/regime_discovery_2026-07-29.py`, outputs `research/backtests/pacing_backtest/regime_out/`. Do NOT modify `pattern_discovery_*`, `rules_out/`, `combo_out/`, `pattern_discovery_out/`, or any other prereg. Concurrent agents are working in this repo.
