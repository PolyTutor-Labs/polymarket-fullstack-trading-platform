...
OUT = os.path.join(ROOT, 'research', 'backtests', 'pacing_backtest', 'audit_out3'); os.makedirs(OUT, exist_ok=True)
...
bf = pd.read_parquet(os.path.join(ROOT, 'research', 'backtests', 'pacing_backtest', 'elon_backfill_ext_to_2026-07-10.parquet'))
