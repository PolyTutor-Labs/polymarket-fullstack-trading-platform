...
`research/backtests/pacing_backtest/prereg/pattern_discovery_2026-07-26.md` -- read
...
def write_summary(df, results, data, null_check, excluded_subset):
    ...
    lines.append("")
    lines.append("Pre-registration: `research/backtests/pacing_backtest/prereg/pattern_discovery_2026-07-26.md`. "
                 "Scope: (b) pure forecast-accuracy / calibration diagnostic. No P&L, no fills. "
