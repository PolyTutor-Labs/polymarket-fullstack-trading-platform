...
Prior audit (FAIL/BLOCK): `research/backtests/pacing_backtest/audits/pattern_discovery_2026-07-26.md`
Pre-registration: `research/backtests/pacing_backtest/prereg/pattern_discovery_2026-07-26.md` (mtime 2026-07-26 11:21, unchanged since original run - confirmed not edited to match results)
