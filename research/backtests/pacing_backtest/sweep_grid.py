...
ROOT=str(Path(__file__).resolve().parents[3]); CANON=f"{ROOT}/_DataMetricPulls/canonical"; PMX=f"{ROOT}/_DataMetricPulls/pmxt_pulled"; OUT=f"{ROOT}/research/backtests/pacing_backtest/audit_out3"
