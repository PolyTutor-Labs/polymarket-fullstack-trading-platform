...
# ---- tweets ----
tw=pd.read_parquet('research/backtests/pacing_backtest/elon_backfill_2025-09_to_now.parquet')
...
# ---- prices ----
pr=pd.read_parquet('research/backtests/pacing_backtest/clob_prices.parquet')
...
R.to_csv('research/analysis/elon_schedule_analysis/persistence_vs_market_results.csv',index=False)
